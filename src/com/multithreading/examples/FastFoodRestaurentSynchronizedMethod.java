...
public class FastFoodRestaurentSynchronizedMethod {

	private String lastClientName;
	private int numberOfBurger;

	public synchronized void byBurger(String clientName) {
		alongRunningProcess();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		FastFoodRestaurentSynchronizedMethod fastFoodRestaurent = new FastFoodRestaurentSynchronizedMethod();
